...
describe('Check-in service', () => {
    ...
    beforeEach(async () => {
        ...
        sut = new FetchUserCheckInsHistoryService(checkInsRepository) // sut = system under test
    ...
    it('should be able to fetch check-in history', async () => {
        ...
        const { checkIns } = await sut.handle({ userId: 'user-01', page: 1 })
    ...
    it('should be able to fetch paginated check-in history', async () => {
        ...
        const { checkIns } = await sut.handle({ userId: 'user-01', page: 2 })
